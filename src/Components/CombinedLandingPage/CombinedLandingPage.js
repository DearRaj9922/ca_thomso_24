...
import CampusAmbassador from "../Landing/Page_3/CampusAmbassador";
...
const CombinedLandingPage = () => {
  return (
    <div className="combined-landing-page">
      ...
      <section className="parallax-section" id="section3">
        <CampusAmbassador />
      </section>
      <section className="parallax-section" id="section4">
        <Landing4 />
      </section>
      <section className="parallax-section" id="section5">
        <Landing5 />
      </section>
    </div>
  );
