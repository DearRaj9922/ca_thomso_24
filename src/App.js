      ...
      <Router>
        <Routes>
          <Route
            ...
            element={
              <ParallaxWrapper>
                <HeroSection className="parallax-element" data-speed="0.5" />
              </ParallaxWrapper>
            }
          />
          <Route
            ...
            element={
              <ParallaxWrapper>
                <Landing2 className="parallax-element" data-speed="0.4" />
              </ParallaxWrapper>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <ParallaxWrapper>
                <Landing4 className="parallax-element" data-speed="0.3" />
              </ParallaxWrapper>
            }
          />
          <Route
            ...
            element={
              <ParallaxWrapper>
                <Landing5 className="parallax-element" data-speed="0.1" />
              </ParallaxWrapper>
            }
          />
